# PRNexGen - Innovating the Next Generation of Digital Solutions

A modern, professional landing page for PRNexGen, an IT startup delivering web & mobile development, AI automation, cloud infrastructure, and cybersecurity services. Built with Next.js 14, TypeScript, and Tailwind CSS.
...
The portfolio includes sample projects covering different industries:
- **SmartShop E-Commerce**: Custom online shopping platform for retail
- **HealthTrack**: Mobile app for patient and appointment management
- **FinanceFlow**: Financial management system for small businesses
- **EduLearn Platform**: Online learning management system
- **LogiTrack Pro**: Real-time logistics and delivery tracking
- **RestaurantPOS**: Point of sale system for restaurant management

      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
            From idea to launch, PRNexGen turns your vision into a high-performance digital product.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="btn-gradient px-8 py-4 rounded-xl font-semibold text-base flex items-center justify-center gap-2 hover:shadow-2xl transition-shadow"
            >

        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-white mb-6 leading-tight">
              Ready to Build <span className="gradient-text">Your Career?</span>
            </h2>

            <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
              Whether you&apos;re a fresher or an experienced professional, PRNexGen is the place to grow.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="btn-gradient px-8 py-4 rounded-xl font-semibold text-base flex items-center justify-center gap-2"
              >
              ...
              >
                <FiMail size={18} /> Contact HR
              </a>
            </div>

            <p className="mt-8 text-gray-600 text-sm">
              No applications expire · We review every submission · Response within 5–7 days
            </p>
          </motion.div>
        </div>
      </section>

  ...
  return (
    <section id="projects" className="my-20">
      ...
      <p className="mb-12 max-w-2xl text-gray-700 dark:text-gray-300">
        From web & mobile applications to AI automation and cloud solutions, our work helps businesses scale smarter. Explore some of the
        platforms, tools, and solutions we've created for our clients.
      </p>

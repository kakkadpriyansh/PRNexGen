      ...
      <div className="p-8 md:p-10 lg:p-12 flex flex-col md:flex-row items-start">
        ...
        <div className="w-full md:w-3/5 z-10">
          <h2 className="text-black dark:text-white mb-6 text-3xl md:text-4xl lg:text-5xl font-medium leading-tight">
            Ready to Transform <span className="text-blue-600 dark:text-blue-400">Your Business?</span>
          </h2>
          <p className="my-6 text-sm md:text-base max-w-md text-gray-700 dark:text-gray-300">
            Have a project in mind or need expert IT consulting?
          </p>
          <p className="mb-6 text-sm md:text-base max-w-md text-gray-700 dark:text-gray-300">
            Let's discuss your requirements and create a roadmap for success. We're here to help you build the future.
          </p>
          <div>
            <ContactFormButton />
          </div>
